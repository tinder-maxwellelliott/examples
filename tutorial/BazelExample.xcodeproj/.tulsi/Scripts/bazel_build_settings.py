...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/maxwellelliott/go/bin/bazelisk',
    '/private/var/tmp/_bazel_maxwellelliott/d505e5758d27821c20bebbeccdfc0058/execroot/__main__',
    'ios_x86_64',
    {
        'watchos_armv7k': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/maxwellelliott/Library/Application Support/Tulsi/0.20200514.88/Bazel',
